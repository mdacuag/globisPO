...
<!-- 	@forelse($selected as $select)
 ...
 <h1>Create PO</h1>
<hr/>
				<form action="{{url('/PO')}}" class="form-horizontal"  method="put">
					{{ csrf_field() }}
<!-- 					<div class="col-lg-3">
							...
							<tr>
								...
								<td>
									<select class="form-control" name="uom[]" id="uom">
										<option value="" style="display:none;">Select UOM</option>
					...
					<div class="col-lg-offset-1 col-md-8 col-sm-6">
						...
						<div class="form-group{{ $errors->has('terms') ? ' has-error' : '' }}">
							...
							<div class="col-lg-7">
								<input id="terms"  type="text" class="form-control" name="terms" value="{{ old('terms') }}">
								@if ($errors->has('terms'))
								<span class="help-block">
						...
						<div class="form-group{{ $errors->has('instruc') ? ' has-error' : '' }}">
							...
							<div class="col-lg-7">
								<textarea class="form-control" rows="3" id="instruc" name="instruc" value="{{ old('instruc') }}"></textarea>
						...
						<div class="form-group{{ $errors->has('discount') ? ' has-error' : '' }}">
							...
							<div class="col-lg-7">
								<input name="discount" class="form-control" type="number"  step=0.01 >
						...
						<div class="form-group{{ $errors->has('approved') ? ' has-error' : '' }}">
							...
							<div class="col-lg-7">
								<input id="approved"  type="text" class="form-control" name="approved" value="{{ old('approved') }}">
						...
						<div class="form-group{{ $errors->has('aposition') ? ' has-error' : '' }}">
							...
							<div class="col-lg-7">
								<input id="aposition"  type="text" class="form-control" name="aposition" value="{{ old('aposition') }}">
